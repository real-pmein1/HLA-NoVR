...
Download [here](https://github.com/HLANoVR/HLA-NoVR/archive/refs/heads/main.zip) and extract the `game` folder to your Alyx root folder where there should already be a folder called `game`.

[Download and run the official launcher](https://github.com/HLANoVR/HLA-NoVR-Launcher/releases/latest) from any folder.  It will ask where your Alyx installation is.  Choose the location of the `game` folder.
...
- FrostEpex for Storage script from his tools package: https://github.com/FrostSource/hla_extravaganza